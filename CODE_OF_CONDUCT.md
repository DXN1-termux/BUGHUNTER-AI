...
* Keeping discussions technical — this is a security research project, not a political forum
...
* Sharing offensive security techniques for unauthorized targets ("hack my ex's account")
* **Zero tolerance for CSAM, terrorism facilitation, CBRN content, or any content the hard-block layer of this project refuses** — if the tool blocks it, don't ask for it in issues either
...
This Code of Conduct applies within all community spaces (GitHub repo, discussions, issues, PRs, WhatsApp support, any official channels), and also applies when an individual is officially representing the community in public spaces.
...
**Consequence**: Private written warning, clarity around the violation, and why it was inappropriate. A public apology may be requested.
...
### 4. Permanent Ban
**Community Impact**: Demonstrating a pattern of violation, harassment, or aggression toward classes of individuals. Includes any attempt to use this project for CSAM, terrorism, CBRN, or mass-harm purposes.
